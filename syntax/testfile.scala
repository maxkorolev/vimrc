...
package object SomeObject[A <: B] extends Implicits with SomeType {
...
@tailrec
class ScalaClass(
    realParamName: Int = 12, 
    secondName: Trait[A, Trait[B, C]]
  ) extends B with SomeTrait[A, B[String], D] {
  /**
