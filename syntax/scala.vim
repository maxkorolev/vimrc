...
syn keyword scalaKeyword catch do else final finally for forSome if this
syn keyword scalaKeyword match return throw try while yield macro
syn keyword scalaKeyword class trait object nextgroup=scalaInstanceDeclaration skipwhite
syn keyword scalaKeyword extends with nextgroup=scalaInheritanceInstanceDeclaration skipwhite
syn keyword scalaKeyword case nextgroup=scalaKeyword,scalaCaseFollowing skipwhite
syn keyword scalaKeyword val var nextgroup=scalaNameDefinition,scalaQuasiQuotes skipwhite
syn keyword scalaKeyword def nextgroup=scalaNameDefDefinition skipwhite
...
hi link scalaChar PreProc
hi link scalaEscapedChar Function
hi link scalaUnicodeChar PreProc

syn match scalaOperator "||"
syn match scalaOperator "&&"
hi link scalaOperator Keyword

syn match scalaNameDefDefinition /\<[_A-Za-z0-9$]\+\>/ contained nextgroup=scalaPostNameDefinition,scalaVariableDeclarationList
syn match scalaNameDefDefinition /`[^`]\+`/ contained nextgroup=scalaPostNameDefinition
hi link scalaNameDefDefinition String
...
syn match scalaInheritanceInstanceDeclaration /\<[_\.A-Za-z0-9$]\+\>/ contained nextgroup=scalaInstanceHash
syn match scalaInheritanceInstanceDeclaration /`[^`]\+`/ contained
hi link scalaInstanceDeclaration Special
hi link scalaInheritanceInstanceDeclaration String
hi link scalaInstanceHash String
...
hi link scalaTypeTypeDeclaration Function
...
hi link scalaTypeDeclaration Function
...
hi link scalaSpecialFunction Normal

syn keyword scalaSpecial new nextgroup=scalaInstanceDeclaration skipwhite
syn match scalaSpecial "\%(=>\|⇒\|<-\|←\|->\|→\)"
syn match scalaSpecial /`[^`]\+`/  " Backtick literals
hi link scalaSpecial String
...
hi link scalaString PreProc
hi link scalaStringEmbeddedQuote PreProc
...
hi link scalaIString PreProc
hi link scalaTripleIString PreProc
...
hi link scalaTripleString PreProc
hi link scalaTripleFString PreProc

hi link scalaInterpolationBrackets Keyword
hi link scalaInterpolationBoundary Keyword
...
hi link scalaNumber Constant

syn keyword scalaBoolean true false
hi link scalaBoolean Constant

syn region scalaRoundBrackets matchgroup=scalaSquareBracketsBrackets start="(" end=")" skipwhite contained contains=scalaTypeDeclaration,scalaSquareBrackets,scalaRoundBrackets
...
hi link scalaSquareBracketsBrackets String
hi link scalaTypeOperator String
...
hi link scalaAnnotation String
